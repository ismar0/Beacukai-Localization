...
frappe.query_reports["LAPORAN POSISI BARANG DALAM PROSES"] = {
    filters: [
        {
            fieldname: "from_date",
            label: "From Date",
...
function getReportData() {
    ...
    frappe.call({
        method: "beacukai.beacukai.report.laporan_posisi_barang_dalam_proses.laporan_posisi_barang_dalam_proses.execute",
