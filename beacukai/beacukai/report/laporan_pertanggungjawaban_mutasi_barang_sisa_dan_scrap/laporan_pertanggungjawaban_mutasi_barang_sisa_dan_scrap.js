...
frappe.query_reports["LAPORAN PERTANGGUNGJAWABAN MUTASI BARANG SISA DAN SCRAP"] = {
    filters: [
        {
            fieldname: "from_date",
            label: "From Date",
...
function getReportData() {
    ...
    frappe.call({
        method: "beacukai.beacukai.report.laporan_pertanggungjawaban_mutasi_barang_sisa_dan_scrap.laporan_pertanggungjawaban_mutasi_barang_sisa_dan_scrap.execute",
...
function renderExportButtons() {
    ...
    if (!exportWrapper) {
        ...
        exportExcelBtn.onclick = () => tabulatorInstance.download("xlsx", "laporan_mutasi_barang_sisa_dan_scrap.xlsx");

        let exportPdfBtn = document.createElement("button");
        exportPdfBtn.innerText = "📄 Export to PDF";
        exportPdfBtn.onclick = () => tabulatorInstance.download("pdf", "laporan_mutasi_barang_sisa_dan_scrap.pdf", {
            orientation: "landscape",
            title: "Laporan Pertanggungjawaban Mutasi Barang Sisa dan Scrap"
        });
