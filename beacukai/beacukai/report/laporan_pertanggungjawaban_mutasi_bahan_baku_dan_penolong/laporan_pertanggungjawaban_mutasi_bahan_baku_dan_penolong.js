...
frappe.query_reports["LAPORAN PERTANGGUNGJAWABAN MUTASI BAHAN BAKU DAN PENOLONG"] = {
    filters: [
        {
            fieldname: "from_date",
            label: "From Date",
...
function getReportData() {
    ...
    frappe.call({
        method: "beacukai.beacukai.report.laporan_pertanggungjawaban_mutasi_bahan_baku_dan_penolong.laporan_pertanggungjawaban_mutasi_bahan_baku_dan_penolong.execute",
...
function renderExportButtons() {
    ...
    if (!exportWrapper) {
        ...
        exportExcelBtn.onclick = () => tabulatorInstance.download("xlsx", "laporan_mutasi.xlsx");

        let exportPdfBtn = document.createElement("button");
        exportPdfBtn.innerText = "📄 Export to PDF";
        exportPdfBtn.onclick = () => tabulatorInstance.download("pdf", "laporan_mutasi.pdf", {
